...
void dispKeys()
{
	...
	cout << endl;
	cout << "Controller mode:" << endl;
	cout << "w,a,s,d: move the control unit" << endl;
	cout << "Enter: dock/undock";
	cout << "Space: shoot if docked" << endl;
	cout << endl;
	...
	cout << " Light Post Views / controller mode" << endl;
	cout << "m: Toggle mouse controls for Perspective mode." << endl;
	cout << "r: Reset camera." << endl;
	cout << "1-8: switch to camera modes directly." << endl;
	cout << endl;
